...
- **Project A (Generic)**: Create a ChatGPT Project with empty instructions
- **Project B (Profiled)**: Create a ChatGPT Project with a full PIC sample profile pasted in

Use a fictional student or your own profile for Project B. The sample should include clear preferences (e.g., "learns through video, concise bullet points, intuitive thinker") so the contrast is visible.

### 2. Test Demo Prompts
Run these 3 prompts in BOTH projects to confirm the difference is clear:

1. *"Explain the concept of cognitive load theory to me"*
2. *"I'm stuck on my essay. I don't know how to structure the argument."*
3. *"Help me write a summary of my research findings"*

If the responses look too similar, make the sample profile more specific.

### 3. Publish the GPT
- Ensure Student GPT - Personal is published and accessible
- Test the link on a different device/account
- Generate a QR code pointing to the GPT link

### 4. Room Setup
- Projector showing your ChatGPT screen (2 projects side-by-side or tabbed)
- QR code handout printed or ready to project
- Wi-Fi credentials visible (whiteboard or slide)
...
- Common issues: "I don't know which answer to pick" → remind them there are no wrong answers
- If someone finishes early, have them ask a classmate to compare profiles
- At 15 min, announce "wrap up if you can, we'll look at results"
